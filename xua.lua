...
if not isfolder("xua") then
    makefolder("xua")
end

if not isfolder("xua/configs") then
    makefolder("xua/configs")
end

if not isfolder("xua/configs/da_hood") then
    makefolder("xua/configs/da_hood")
end
...
local UserInterface = (function() -- src/Lua/Interface/Interface.Lua
    ...
    getgenv().theme = {
        accent = Color3FromRGB(96, 78, 162)
    }
                ...
                do -- src/Lua/Interface/Components/
                    ...
                    do -- src/Lua/Interface/Components/Colorpicker.lua
                        function Options:Colorpicker(Configuration, ToggleOption)
                            ...
                            Accent.BackgroundColor3 = Color3FromRGB(96, 78, 162)
                            ...
                            function Dropdown:CreateValue(name)
                                if not Dropdown.FValues[name] then
                                    ...
                                    local function Click()
                                        DBName.TextColor3 = Color3.fromRGB(96, 78, 162)
                        ...
                        function Options:Keybind(Configuration, toggle)
                            ...
                            for _, v in pairs({ "Toggle", "Hold", "Always" }) do
                                ...
                                function Button:Click(igr)
                                    ...
                                    KB_Button.TextColor3 = Color3FromRGB(96, 78, 162)
                    ...
                    do -- src/Lua/Interface/Components/Toggle.lua
                        function Options:Toggle(Configuration)
                            ...
                            local TS_ON = tweenService:Create(ToggleStatus, TweenInfo.new(0.2), {
                                BackgroundColor3 = Color3FromRGB(96, 78, 162)
                            })
...
local nigga = (function() -- src/Lua/loader.lua
    ...
    function loaderOptions:new()
        ...
        InfoGame.Image = "rbxassetid://18511032614"
    ...
    local function my_script()
                ...
                if please_load then
                    do
                        (function() -- src/Lua/Scripts/da_hood/things.lua
                            ...
                            -- HAD TO FUCKING MAKE ANOTHER ONE FOR legit
                    ...
                    local Interface = UserInterface:Create{title = 'xua<font color="rgb(96, 78, 162)">.lua</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        do -- src/Lua/Scripts/da_hood/components/a_aimassist.lua
                            ...
                            -- interface
                            local aim_assist = Interface:Tab( "rage" )
                            ...
                            settings:Toggle({ title = "friend check", default = false, callback = function (bool)
                                aimassist.configuration.friends = bool
                            end })
                            
                            settings:Toggle({ title = "team check", default = false, callback = function (bool)
                        ...
                        do -- src/Lua/Scripts/da_hood/components/b_silentaim.lua
                            ...
                            local silent_aim = Interface:Tab( "legit" )
                            ...
                            main:Toggle({ title = "sync with camlock", default = false, callback = function (bool)
                            ...
                            settings:Toggle({ title = "friends check", default = false, callback = function (bool)
                            ...
                            settings:Toggle({ title = "visibility check", default = false, callback = function (bool)
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- rage render
                                local aim_assist_render = renderTab:Section("rage", "left")
                            ...
                            do -- legit render
                                ...
                                local silent_aim_render = renderTab:Section("legit", "left")
                            ...
                            do -- indicator
                                ...
                                renderindicator:Dropdown({ title = "indicate values", values = {"rage", "legit"}, default = "rage", multi = true, callback = function (value)
                                    indicatorClass.indicate = value
                                end })
                                
                                local title = indicatorClass:new_indicator("xua.lua")
                                ...
                                local randomshit = coroutine.create(function ()
                                    while task.wait() do
                                        ...
                                        do
                                            ...
                                            local textValue = character_available and aimassist.character.Name or "rage : no target"
                                            aim_Ass_character.changetext(textValue)
                                    
                                            local aim_vis = table.find(indicatorClass.indicate, "rage") and indicatorClass.enabled and true or false
                                            aim_Ass_character.changeVisibility(aim_vis)
                                        end
                                        do
                                            local character_available = silentaim.character and silentaim.character.Name
                                            local textValue = character_available and silentaim.character.Name or "legit : no target"
                                            silent_Ass_character.changetext(textValue)
                                    
                                            local aim_vis = table.find(indicatorClass.indicate, "legit") and indicatorClass.enabled and true or false
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("xua/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("xua/configs/da_hood") do
                            ...
                            local NOTE = settingsTab:Section("FOUNDERS", "left")
                            NOTE:Label("cnv : s7qv")
                            ...
                            getgenv().theme = {
                                accent = Color3FromRGB(96, 78, 162),
                                scroll = Color3FromRGB(96, 78, 162)
                            }
                            
                            local old_theme = table.clone(getgenv().theme)
                            local theme_objects = {}
                            
                            theme_objects["accent"] = theme_section:Colorpicker({ title = "accent", default = Color3.fromRGB(96, 78, 162), transparency = 1, callback = function (value, transparency)
                                theme.accent = value
                                theme_event:Fire()
                            end })
                            
                            theme_objects["scroll"] = theme_section:Colorpicker({ title = "scrollbar", default = Color3.fromRGB(96, 78, 162), transparency = 1, callback = function (value, transparency)
                                theme.scroll = value
                                theme_event:Fire()
                            end })
                            ...
                            menu_misc:Keybind({title = "menu keybind", keybindlist = false, keybindname = "menu:", key = "V", callback = function (bool)
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'xua<font color="rgb(96, 78, 162)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    do -- src/Lua/Scripts/universal/components/a_aimassist.lua
                        ...
                        main_enabled:Keybind({ keybindlist = true, keybindname = "rage", key = "MB2", callback = function (bool)
                            aimassist.keybind = bool
                            if bool then
                                gacHandlers.resume()
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local fucking_shitty_indicator = {
                            ...
                            new_indicator = function ( self, name )
                                ...
                                local indicattt = DrawingClass({ "Text", { Font = 2, Visible = false, Transparency = 1, Text = name, Outline = true, Center = true, Color = Color3.fromRGB(96, 78, 162), Size = 14 } })
                        ...
                        local title = fucking_shitty_indicator:new_indicator("xua.lua")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
...
--[[
local Interface = UserInterface:Create{title = 'fatality<font color="rgb(96, 78, 162)">.dev</font>',}
...
local aim_assist = legitTab:Section("rage", "left")
